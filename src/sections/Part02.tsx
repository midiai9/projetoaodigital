...
export function MotorDivider() {
  return (
    <PartDivider
      ...
      intro="Da pergunta à decisão: como cada resposta vira lead qualificado, relatório e, para os selecionados, uma oportunidade Maestro."
      icon={Settings}
    />
  )
}
...
export function Workflow() {
  const steps = [
    ...
    { icon: Cpu, t: 'Seleção Maestro', d: 'Leads A viram Sessão Executiva e POV do Maestro.' },
  ]
  return (
    <Section id="workflow" tone="light">
      <Reveal>
        <SectionHeader
          ...
          title="Da captação à seleção para o Maestro"
        />
      </Reveal>
    ...
    <Section id="qualificacao" tone="muted">
      <Reveal>
        <SectionHeader
          ...
          title="Nem todo respondente é um lead Maestro — e tudo bem"
        />
      </Reveal>
      ...
      <Reveal delay={0.1}>
        <div className="mt-6 flex items-start gap-4 rounded-2xl border border-brand-purple/20 bg-white p-6 shadow-card">
          ...
          <p className="text-sm leading-relaxed text-ink-700">
            <strong className="text-ink-900">Critério de entrada no Maestro:</strong>{' '}
            ...
            “Decision Team First” do Maestro (6 a 8 semanas).
          </p>
        </div>
      </Reveal>
    </Section>
